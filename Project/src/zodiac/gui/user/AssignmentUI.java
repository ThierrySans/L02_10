...
public class AssignmentUI extends JFrame implements ActionListener {
  ...
  protected void createContents() {
    ...
    TreeMap<Question, String> temporalAnswer = StudentAction
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (e.getActionCommand() == btnSaveNext.getActionCommand()) {
      ...
      if (currentAt == questions.size() - 1) {
        ...
        StudentAction.addTempAnswerToQuestion(student, assignment, questions.get(currentAt),
            rdbts.get(answers.get(currentAt)).getText());
