...
/**
 * Created by radiantwings on 10/24/17. This class represents an Assignment that
 * Students will complete. An assignment will typically hold >= 1 Questions
 */
public class Assignment {
	...
	/**
	 * Return the number of maximum attempts allowed for an assignment. Returns
	 * 0 if infinite attempts are allowed.
	 *
